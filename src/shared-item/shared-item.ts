...
export class SharedItem extends BlDocument {
  item: string | Item; // the item this shared item is a "duplicate" of
  ...
  customerItem?: string | CustomerItem; // if it is currently held by a customer, this points to a customerItem
  handoutInfo: {
