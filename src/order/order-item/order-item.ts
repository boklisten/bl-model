...
export class OrderItem {
  ...
  customerItem?: string | CustomerItem; // if this orderItem is for a customerItem, this is the id of the customerItem
  match?: string; // if the orderItem is part of a match
  movedToOrder?: string | Order; // if the orderItem is added again in a new order, this points to it
  movedFromOrder?: string | Order; //if the orderItem is from another order, this points to it
}
